		...
		<div id="login" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				...
				<div class="modal-body">
					<form method="post">
					<center>
						<input type="email" name="email" placeholder="E-mail" style="width:250px;">
...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="contactus.php"><i class="icon-inbox"></i>Review/Suggestion</a></li>
				<li><a href="privacy.php"><i class="icon-info-sign"></i>Privacy Policy</a></li>
				<li><a href="faqs.php"><i class="icon-question-sign"></i>FAQs</a></li>
			</ul>
	</div>

	<img src="img/hom.jpg" style="width:1150px; height:250px; border:1px solid #000; ">
	<br />
	<br />
	...
	<div id="carousel">
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				...
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner4.jpg" class="carousel"></div>
			</div>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:20px;"><center> &copy StreetWare Inc. 2020 </center></p>
		</div>
	</div>
</body>
</html>