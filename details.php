...
<div id="container">
	<div class="nav">	
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of StreetWare Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">StreetWare Inc. Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
						...
						<li>All prices quoted are in Malaysian Ringgit. Price and availability information is subject to change without notice.</li>
						<li>Mode of payment are as follows:customers with bank account can pay through online banking otherwise Cash on Delivery(COD).</li>
						<li>Upon receiving your product we will charge for delivering for only 5 Ringgit, depending on the location.</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
