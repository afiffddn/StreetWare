	...
	<br />
		...
		<div id="video">
			<video controls autoplay width="445px" height="300px">
				<source src="video/comm.mp4" type="video/mp4">
			</video>
		</div>
		
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2><legend>SPECIAL PROMOTION</legend></h2></center>
			<br />
			
			<?php 
				
				$query = mysqli_query($conn, "SELECT *FROM product WHERE category='promo' ORDER BY product_id DESC") or die (mysqli_error());
...
<br />
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;"><center> StreetWare Inc. 2020 </center></p>
		</div>
	</div>
</body>
</html>