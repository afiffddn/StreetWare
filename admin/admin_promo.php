...
<body>
	...
	<br>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="promo"></td>
							</tr>
						</table>
					</center>
				</div>
		...
		<?php
			if (isset($_POST['add']))
				...
				exit(header ("location:admin_promo.php"));
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2> Promotions </h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					echo "<a href='delete.php?id=".$id."' class='btn btn-danger' rel='facebox'><i class='icon-minus-sign icon-white'></i> Remove Product </a>";
					?>
					</td>
				</tr>		
				<?php
